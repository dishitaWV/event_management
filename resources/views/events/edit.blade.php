...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 justify-content-center">
        ...
        {{--        <div class="col-xs-12 col-sm-12 col-md-12">--}}
                    <div class="form-group">
                        <strong>Type:</strong>
                        <input type="text" name="type" class="form-control" placeholder="Event Type" value="{{ $Event->type }}">
                        @error('type')
                        <div style="color: red">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        {{--        <div class="col-xs-12 col-sm-12 col-md-12">--}}
                    <div class="form-group">
                        <strong>Date:</strong>
                        <input type="text" class="form-control custom_date_picker" id="event_date" name="event_date" placeholder="yyyy-mm-dd" value="{{ $Event->event_date }}">
                        @error('event_date')
                        <div style="color: red">{{ $message }}</div>
                        @enderror
                    </div>
